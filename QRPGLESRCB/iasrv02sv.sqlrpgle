...
//26/06/24| 0030   | Munumonika | Following changes are done on Task# 431              //
//        |        |            | 1. Added Logic to check longname ds, long name subfield//
//        |        |            |    and no name ds for fixed format ds declaration    //
//        |        | Manasa     | 2. Increased new parm for DS long name               //
//        |        |            | 3. DS declared with LikeDS keyword entry not added   //
//        |        |            |    to IAPGMDS file.                                  //
//15/05/24| 0031   | Sovan K    | Duplicate records in IAPGMVARS for PR in free format //
//        |        |            | Fixed the logic for PR in Free format alone.         //
//        |        |            | Task #666                                            //
...
dcl-proc IACPYFRMIMPF export;
   ...
   clear w_IAPGMFILES;
   w_IAPGMFILES.FLSRCMBR  = w_ParmDS.w_SrcMbr;
   w_IAPGMFILES.FLSRCPFNM = w_ParmDS.w_SrcPf;
   w_IAPGMFILES.FLLIBNM   = w_ParmDS.w_SrcLib;
   ...
   w_IAPGMFILES.FLKWUSG = w_WordsArray(1);
...
//Handling case when we have value in variable "w_FileKeyPos" with length more than 10
   ...
   exec sql
     insert into IAPGMFILES (FLLIBNM,
                             FLSRCPFNM,
                             FLSRCMBR,
                             FLPGFILE,
                             FLKWUSG)
       values(trim(:w_IAPGMFILES.FLLIBNM),
              trim(:w_IAPGMFILES.FLSRCPFNM),
              trim(:w_IAPGMFILES.FLSRCMBR),
              trim(:w_FileKeyPos),
              trim(:w_IAPGMFILES.FLKWUSG));
...
dcl-proc IAPRADDPFM export;
 ...
 //if %scan('/':w_FileKeyPos) > 0;                                                         //KM
 //PS01 if %scan('/':w_FileKeyPos) > 1;                                                    //KMm
   ...
   WrtSrcIntRefF(w_IAPGMFILES.FLLIBNM                                                     //AK11
                :w_IAPGMFILES.FLSRCPFNM                                                   //AK11
                :w_IAPGMFILES.FLSRCMBR                                                    //AK11
                :in_MbrTyp1                                                               //AK11
                :w_FileKeyPos                                                             //AK11
                :'*FILE'                                                                  //AK11
                :w_LibName                                                                //AK11
...
dcl-proc IAPRCLRPFM export;
 ...
 //if %scan('/':w_FileKeyPos) > 0;                                                        //KM
 //PS01  if %scan('/':w_FileKeyPos) > 1;                                                  //KM
...
dcl-proc IAPRCPYF export;
   ...
   w_IAPGMFILES.FLKWUSG = w_WordsArray(w_Count);
   ...
   if s_pos > 1 and f_len > s_pos;
      ...
      w_IAPGMFILES.FLPGFILE = %subst(w_FileName:s_pos+1:f_len-s_pos);
   else;
      w_LibName = *Blanks;
      w_IAPGMFILES.FLPGFILE = w_FileName;
   endif;

   exec sql                                                                              //0017
     insert into IAPGMFILES (FLLIBNM,                                                    //0017
                             FLSRCPFNM,                                                  //0017
                             FLSRCMBR,                                                   //0017
                             FLPGFILE,                                                   //0017
                             FLPGFMT,                                                    //0017
                             FLKWUSG)                                                    //0017
       values(trim(:w_IAPGMFILES.FLLIBNM),                                               //0017
              trim(:w_IAPGMFILES.FLSRCPFNM),                                             //0017
              trim(:w_IAPGMFILES.FLSRCMBR),                                              //0017
              trim(:w_IAPGMFILES.FLPGFILE),                                              //0017
              trim(:w_IAPGMFILES.FLPGFMT),                                               //0017
              trim(:w_IAPGMFILES.FLKWUSG));                                              //0017

   //Write source intermediate reference detail file
   WrtSrcIntRefF(w_IAPGMFILES.FLLIBNM
                :w_IAPGMFILES.FLSRCPFNM
                :w_IAPGMFILES.FLSRCMBR
                :in_MbrTyp1
                :w_IAPGMFILES.FLPGFILE
                :'*FILE'
                :w_LibName
              //:1                                                                       //0023
                :'I'                                                                     //0023
...
dcl-proc IAPRCRTPF export;
 ...
 //PS01 if %scan('/':w_FileKeyPos) > 1;                                                        //KM
   ...
   WrtSrcIntRefF(w_IAPGMFILES.FLLIBNM                                                     //AK12
                :w_IAPGMFILES.FLSRCPFNM                                                   //AK12
                :w_IAPGMFILES.FLSRCMBR                                                    //AK12
                :in_MbrTyp1                                                               //AK12
                :w_FileKeyPos                                                             //AK12
                :'*FILE'                                                                  //AK12
                :w_LibName                                                                //AK12
...
dcl-proc IAPRDFOVR export;
   ...
   dcl-s tempFILEKywrd char(40)            inz;                                          //MT01
   dcl-s w_Count packed(3:0);                                                            //MT01
   dcl-s i       packed(3:0);                                                            //MT01
   dcl-s w_Lib   char(10);                                                               //MT01
   dcl-s Library char(10);                                                               //MT01
   ...
   w_FileKeyPos = scanKeyword(' FILE(':w_ClStatement);
   tempFILEKywrd = w_FileKeyPos ;                                                        //MT01
   ...
   if s_pos > 1 and f_len > s_pos;                                                       //AJ01
      w_IAPGMFILES.FLPGFILE = %subst(w_FileKeyPos:s_pos+1:f_len-s_pos);
      w_lib = %subst(w_FileKeyPos : 1 : s_pos-1);                                        //MT01
      w_IASRCINTPF.IAREFOBJ = w_IAPGMFILES.FLPGFILE ;                                    //0032
      w_IASRCINTPF.IAREFOLIB = w_lib;                                                    //0032
   else;
      w_IAPGMFILES.FLPGFILE = w_FileKeyPos;
      w_IASRCINTPF.IAREFOBJ = w_IAPGMFILES.FLPGFILE ;                                    //0032
   endif;

   w_IAPGMFILES.FLPGFMT = scanKeyword(' RCDFMT(':w_ClStatement);
   if tempFILEKywrd <> *blanks;                                                          //MT01
      if w_IAPGMFILES.FLPGFMT <> *blanks;                                                //MT01
         w_IAPGMFILES.FLPGFMT = w_WordsArray(5);                                         //MT01
      endif;                                                                             //MT01
   else;                                                                                 //MT01
      if w_IAPGMFILES.FLPGFMT <> *blanks;                                                //MT01
         w_IAPGMFILES.FLPGFMT = w_WordsArray(4);                                         //MT01
      else;                                                                              //MT01
         if w_lib <> *blanks;                                                            //MT01
            Library = w_lib ;                                                            //MT01
         else;                                                                           //MT01
            Library = w_IAPGMFILES.FLLIBNM;                                              //MT01
         endif;                                                                          //MT01
         w_IAPGMFILES.FLPGFMT = w_WordsArray(3);                                         //MT01
         Exec Sql                                                                        //MT01
           Select count(*) into :w_Count                                                 //MT01
            from IDSPFFD where                                                           //MT01
            WHFILE = trim(:w_IAPGMFILES.FLPGFILE) and                                    //MT01
            WHLIB  = trim(:Library) and                                                  //MT01
            WHNAME = trim(:w_IAPGMFILES.FLPGFMT);                                        //MT01

         if w_count <> *Zeros;                                                           //MT01
            w_IAPGMFILES.FLPGFMT = w_WordsArray(3);                                      //MT01
         else;                                                                           //MT01
            w_IAPGMFILES.FLPGFMT = *blanks;                                              //MT01
         endif;                                                                          //MT01
      endif;                                                                             //MT01
   endif;


  // if %scan(' ': w_IAPGMFILES.FLPGFMT) > 0 and w_IAPGMFILES.FLPGFMT <> *blanks;  //AJ01 //MT01
   s_pos = %scan(' ': w_IAPGMFILES.FLPGFMT);
   if w_IAPGMFILES.FLPGFMT <> *blanks and s_pos > 1;                                     //AJ01
      w_IAPGMFILES.FLPGFMT = %subst(w_IAPGMFILES.FLPGFMT:1:s_pos-1);
   endif;

   w_IAPGMFILES.FLKWPRF = scanKeyword(' OPNID(':w_ClStatement);
   If w_IAPGMFILES.FLKWPRF <> *Blanks;                                                   //MT01
      w_IAPGMFILES.FLKWPRF = %trim(w_IAPGMFILES.FLKWPRF) + '_';
   Endif;                                                                                //MT01
   ...
   exec sql
     insert into IAPGMFILES (FLLIBNM,
       ...
       values(trim(:w_IAPGMFILES.FLLIBNM),
              trim(:w_IAPGMFILES.FLSRCPFNM),
              trim(:w_IAPGMFILES.FLSRCMBR),
              trim(:w_IAPGMFILES.FLPGFILE),
              trim(:w_IAPGMFILES.FLPGFMT),
              trim(:w_IAPGMFILES.FLKWPRF),
              trim(:w_IAPGMFILES.FLKWUSG));
...
Dcl-Proc IAPSRPLSTFX Export;                                                             //0011
   ...
   Dcl-Pi IAPSRPLSTFX;                                                                   //0011
      ...
      In_Srclib    Char(10);                                                             //0011
      In_Srcspf    Char(10);                                                             //0011
      In_Srcmbr    Char(10);                                                             //0011
...
dcl-proc IAPSRFLFR export;
 ...
 //FL_ParseStr = %trimr(in_string);                                                      //SC02
   //SC02 FL_ParseStr = %trim(in_string);                                                     //0002
       ...
       If FL_KeywrdAry(FL_AryIdx) <> *Blanks;
         ...
         when FL_KeywrdAry(FL_AryIdx) = 'EXTFILE';
            ...
            if FL_ExtFile  = '*EXTDESC';
               ...
               if FL_Pos1 > 0;
                  FL_Pos2    = %scan(Fl_Quotes:FL_KeywrdAry(FL_AryIdx+3):
                                        FL_Pos1);
                  If (FL_Pos2-FL_Pos1-1) > 0;                                               //AJ01
                  ...
                  FL_ExtFile = %trim(%xlate(FL_Quotes:Sp:
                                             FL_KeywrdAry(FL_AryIdx+3)));
               endif;
            endif;
   ...
   begsr finddsinfofr;
      ...
      if ds_scoln <> 'Y';
         ...
         when (%scan(' LIKEDS': in_string) > 0);                                //KM
            ...
            if ds_pos7 > 0;                                                     //KM
               ds_LikeDsNm =                                                             //0030
                      %trim(%subst(in_string :(ds_pos1 +7) :ds_pos7));                   //0030
            endif;                                                              //KM
         ...
         when (%scan(' EXTNAME': in_string) > 0);
            ...
            WrtSrcIntRefF(in_srclib :in_srcspf :in_srcmbr :in_type :
   ...
   begsr get_uwdsdtl;
      ...
      //Create IAVVARREL entry for DS Definition...
         ...
         insertIavarrellog(l_CalledFrom  :ds_Attr   :ds_Flag   :in_xref                   //0009
                           :in_srclib    :in_srcspf :in_srcmbr :in_rrn_s                  //0009
...
Dcl-Proc insertIavarrellog EXPORT;                                                        //0009
   Dcl-Pi insertIavarrellog;                                                              //0009
      ...
      in_srclib     char(10);                                                             //0009
      in_srcspf     char(10);                                                             //0009
      in_srcmbr     char(10);                                                             //0009
   ...
   //Insert the variables into IAVARREL File                                             //0009
      ...
      xl_RENUM9 = 0;                                                                      //0009
                                                                                          //0009
      IaVarRelLog(                                                                        //0009
       xl_RESRCLIB  :xl_RESRCFLN   :xl_REPGMNM     :xl_RESEQ       :xl_RERRN              //0009
...
dcl-proc IAPSRDSFX Export;
   dcl-pi IAPSRDSFX;
    ...
    //in_srcmbr  char(10);                                                                    //0002
      in_srclib  char(10) const options(*trim);                                               //0002
      in_srcspf  char(10) const options(*trim);                                               //0002
      in_srcmbr  char(10) const options(*trim);                                               //0002
      in_rrn_s   packed(6:0);
      in_rrn_e   packed(6:0);
      in_dsdcl   char(3);
      in_dsobjv  char(10);
      ...
      in_dsmody  char(10);
      in_uwdsdtl likeds(uwdsdtl_t);
      in_longnm  char(74) options(*nopass) value;                                        //0030
   end-pi;
 ...
 //dcl-s ExtFileNm  char(10) inz;                                                        //0021
   ...
   dcl-s ds_name1       char(128)   inz;                                                 //0030
   dcl-s Wk_Pos         packed(4:0) inz;                                                 //0030
   dcl-s Wk_LongKeyword char(128)   inz;                                                 //0030
   ...
   begsr finddsinfofx;
      ...
      when DspecV4.keyword <> *blank and %scan('LIKEDS' : DspecV4.keyword) > 0 ;         //0007
         ...
         if ds_pos7 > 0 ;                                                                //MT05
            //ds_LikeDsNm = %subst(DspecV4.keyword :(ds_pos1 +7) :ds_pos7);              0007 0030
            ds_LikeDsNm =                                                                //0030
            %trim(%subst(DspecV4.keyword :(ds_pos1 +7) :ds_pos7));                       //0030
         endif ;                                                                         //MT05
      ...
      when (DspecV4.keyword <> *blank and %scan('EXTNAME' : DspecV4.keyword) > 0) and       //0007
         ...
         If ds_pos5 = *Zeros ;                                                           //0030
            Wk_LongKeyword = %trim(DspecV4.keyword) + %trim(DSPECV4.COMMENT);            //0030
            ds_pos5 = %scan(')' : Wk_LongKeyword:ds_pos1+1);                             //0030
         EndIf ;                                                                         //0030
         ...
         if ds_pos5 > ds_pos1+1;                                                         //0021
            ...
            Else ;                                                                       //0030
            ExtFileNm = %subst(Wk_LongKeyword:ds_pos1 +1 :ds_pos5-(ds_pos1+1));          //0030
            EndIf ;                                                                      //0030
         endif;                                                                          //0021
         ...
         WrtSrcIntRefF(in_srclib :in_srcspf :in_srcmbr :in_type :                        //0021
   ...
   begsr get_uwdsdtl;
      ...
      //Create IAVVARREL entry for DS Definition...
         ...
         insertIavarrellog(l_CalledFrom  :ds_Attr   :l_DsFlag  :in_xref                   //0009
                           :ds_LibNm     :ds_srcpf  :ds_MbrNm  :in_rrn_s                  //0009
                           :in_dsdcl     :in_uwdsdtl);                                    //0009
...
dcl-proc IAPSRPRFR Export;
   dcl-pi IAPSRPRFR;
      ...
      in_prc    ind;                                                                     //0016
      in_procNm char(80) options(*omit);                                                 //0024
   end-pi;
   ...
   begsr InsertDDLData;
      ...
      if pr_IaPrcParm.PPRMNAM <> '*N';                                                   //0016
         exec sql                                                                        //0031
           select count(*) into :Count from                                              //0031
           IAPGMVARS Where                                                               //0031
           IAVMBR = trim(:pr_IaPrcParm.PMBRNAM) and                                      //0031
           IAVSFILE = trim(:pr_IaPrcParm.PSRCPF) and                                     //0031
           IAVLIB   = trim(:pr_IaPrcParm.PLIBNAM) and                                    //0031
           IAVVAR   = trim(:pr_IaPrcParm.PPRMNAM) ;                                      //0031
                                                                                         //0031
         if Count = 0;                                                                   //0031
         exec sql                                                                        //0016
...
dcl-proc IAPSRPRFX Export;
   ...
   begsr insertIntoProcInfo;                                                             //0019
      WriteProceduredetail( in_srcmbr                                                    //0013
                           :in_srcspf                                                    //0013
                           :in_srclib                                                    //0013
                           :in_type                                                      //0013
                           :pr_seqNum                                                    //0013
...
dcl-proc WriteLikeDSDtl export;
   ...
   exec sql fetch from IAPSRDS_C4 into :wk_MbrNm, :wk_LibNm, :wk_LikeDsNm, :wk_MainDsNm;
   ...
   dow sqlstate = SQL_ALL_OK;
      ...
      exec sql
        fetch from IAPSRDS_C4 into :wk_MbrNm, :wk_LibNm, :wk_LikeDsNm, :wk_MainDsNm;
   enddo;
...
dcl-proc WrtSrcIntRefF Export;                                                            //0018
  ...
  //in_REFOUSG    Zoned(2:0) const;                                                 //AK11//0023
    ...
    in_RFILEUSG   char(10)   const;                                                       //AK11
                                                                                          ...
                                                                                          //AK11
  Exec Sql                                                                                --AK11
     Insert into IASRCINTPF(IAMBRLIB, IAMBRSRC,  IAMBRNAM,  IAMBRTYP,                     --AK11
...
dcl-proc WriteProceduredetail export;                                             //0013  //SG01
  dcl-pi *n;                                                                              //SG01
    IN_SRCMBR     char(10)   const;                                                       //SG01
    IN_SRCSPF     char(10)   const;                                                       //SG01
    IN_SRCLIB     char(10)   const;                                                       //SG01
...
dcl-proc IAPSRUSRCMD export;                                                             //0014
   ...
   GetWordsInArray(w_ClStatement : w_WordsArray);                                        //0014
   for i = 1 to %elem(w_WordsArray);                                                     //0014

      w_Qualified = 'N';                                                                 //0014
      if w_WordsArray(i) = *blanks;                                                      //0014
         leave;                                                                          //0014
      endif;                                                                             //0014
                                                                                         //0014
      if %scan(':': w_WordsArray(i)) > 0;                                                //0014
         iter;                                                                           //0014
      endif;                                                                             //0014

      if %scan('/': w_WordsArray(i)) > 0                                                 //0014
         and %len(w_WordsArray(i)) > %scan('/': w_WordsArray(i));                        //0014
         w_UsrCmd = %subst(w_WordsArray(i) :                                             //0014
                    %scan('/': w_WordsArray(i))+1  :                                     //0014
                    %len(w_WordsArray(i))-%scan('/': w_WordsArray(i)));                  //0014
         w_CmdLibQ =%subst(w_WordsArray(i) :                                             //0014
                    1 :                                                                  //0014
                    %scan('/': w_WordsArray(i))-1);                                      //0014
         w_Qualified = 'Y';                                                              //0014
      Else;                                                                              //0014
         w_UsrCmd = %Trim(w_WordsArray(i));                                              //0014
      endIf;                                                                             //0014

      exec sql                                                                           //0014
         select odlbnm into :w_CmdLib from iDspOBJD                                      //0014
            where odobnm = :w_UsrCmd and odobtp = '*CMD';                                //0014
