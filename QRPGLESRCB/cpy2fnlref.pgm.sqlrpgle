...
begsr populateObjectDrivenRef;
  ...
  dow rowFound;
     ...
     for uwindx = 1 to RowsFetched;
        ...
        //Populate usRefObjUsage as 'C' if referenced object is display file.
        if usRefObjType = '*FILE';                                                       //0009
           exsr GetRefObjAtr;                                                            //0009
        endif;                                                                           //0009
     ...
     exec sql                                                                            //0016
       select 'Y', iarusages, iamapfrm                                                   //0016
        ...
        where iaoobjlib = :usObjectLib                                                   //0016
          ...
          and iarobjtyp = :usRefObjType;                                                 //0016
  endif;                                                                                 //0016
