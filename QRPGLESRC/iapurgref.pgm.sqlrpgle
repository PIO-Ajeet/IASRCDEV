...
//17/12/24 |  0008  | Naveen G.  | Modified the insert query for IAALLREFHF file to     //
//         |        |            | populate new field Referenced_ObjAtr [Task #1084]    //
//16/08/24 |  0009  | Sabarish   | IFS Member Parsing Upgrade                           //
//------------------------------------------------------------------------------------- //
...
/copy 'QCPYSRC/iaderrlog.rpgleinc'
 ...
 CallP IAEXCTIMR('BLDMTADTA' :udpsds.ProcNme : udpsds.Lib : '*PGM' :                         //0003
                 ...
                 //0009 uptimeStamp : 'INSERT');
                 ' ' : uptimeStamp : 'INSERT');                                          //0009
 ...
 CallP IAEXCTIMR('BLDMTADTA' :udpsds.ProcNme : udpsds.Lib : '*PGM' :                       //0003
                 upsrc_name : uppgm_name : uplib_name : ' ' :
                 //0009 uptimeStamp : 'UPDATE');
                 ' ' : uptimeStamp : 'UPDATE');                                            //0009
