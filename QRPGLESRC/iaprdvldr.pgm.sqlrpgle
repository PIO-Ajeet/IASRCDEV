...
//140224  | 0006   | Akhil K.   | Deleted all the lines that are related to sending     //
//        |        |            | error message to program as this is being handled in  //
//        |        |            | IAMENUR and IASBMSCHR (by retrieving msg from MSGF).  //
//        |        |            | Task #574                                             //
//------------------------------------------------------------------------------------- //
