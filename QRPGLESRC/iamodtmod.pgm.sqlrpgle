...
//        |        |            | with IA*  [Task#261]                                  //
//18/12/24| 0009   | Vivek shar | Task-1084                                             //
//------------------------------------------------------------------------------------- //
...
dcl-s ExportProc_ModAtr    char(10) inz;                                                 //0009
...
begsr RelatedModule;
   ...
   // select iAObjName, iAObjLib                                                  //0009 //0002
      select iAObjName, iAObjLib, iAObjAttr                                              //0009
   ...
   if sqlCode = successCode;                                                             //0003
      ...
      dow rowFound;                                                                      //0003
         ...
         for uwindx1 = 1 to RowsFetched1;                                                //0003
            ...
            ExportProc_ModAtr = ModuleExportProcDs(uwindx1).DsRatr;                      //0009
